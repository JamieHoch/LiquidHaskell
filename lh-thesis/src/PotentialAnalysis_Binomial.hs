...
module PotentialAnalysis_Binomial
    ( link
    , insTree
    , insert
    , merge
...
-- tcost ti + log2 (treeListSize (tval ti)) - log2 (treeListSize ts) <= 1 &&
--log2 (treeListSize (tval ti)) - log2 (treeListSize ts) - log2 (treeSize t) <= 1 &&
